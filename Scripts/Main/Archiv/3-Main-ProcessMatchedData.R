...
# Postal Code count
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#df_Output_PostalCodeCounts_Cologne <- SiteOutputData_Matched$Cologne$df_Output_PostalCodeCounts
#df_Output_PostalCodeCounts_Cologne$Site <- "Cologne"
#names(df_Output_PostalCodeCounts_Cologne)[3] <- "FirstRelevantAdmissionYear"

#df_Output_PostalCodeCounts_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_PostalCodeCounts
#df_Output_PostalCodeCounts_Frankfurt$Site <- "Frankfurt"

#df_Output_PostalCodeCounts_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_PostalCodeCounts
#df_Output_PostalCodeCounts_Freiburg$Site <- "Freiburg"

#df_Output_PostalCodeCounts_MunichLMU <- SiteOutputData_Matched$MunichLMU$df_Output_PostalCodeCounts
#df_Output_PostalCodeCounts_MunichLMU$Site <- "MunichLMU"

#df_Output_PostalCodeCounts_Matched_Main <- rbind(df_Output_PostalCodeCounts_Cologne, 
...
# Sample size
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#df_SampleSize_Cologne <- SiteOutputData_Matched$Cologne$df_Output_SampleSize
#df_SampleSize_Cologne$Site <- "Cologne"
#names(df_SampleSize_Cologne)[2] <- "FirstRelevantAdmissionYear"

#df_SampleSize_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_SampleSize
#df_SampleSize_Frankfurt$Site <- "Frankfurt"

#df_SampleSize_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_SampleSize
#df_SampleSize_Freiburg$Site <- "Freiburg"

#df_SampleSize_MunichLMU<- SiteOutputData_Matched$MunichLMU$df_Output_SampleSize
#df_SampleSize_MunichLMU$Site <- "MunichLMU"

#df_Output_SampleSize_Matched_Main <- rbind(df_SampleSize_Cologne, df_SampleSize_Frankfurt, 
...
# Sex distribution
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#df_Sex_Cologne <- SiteOutputData_Matched$Cologne$df_Output_Sex
...
#df_Sex_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_Sex
#df_Sex_Frankfurt$Site <- "Frankfurt"

#df_Sex_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_Sex
#df_Sex_Freiburg$Site <- "Freiburg"

#df_Sex_MunichLMU <- SiteOutputData_Matched$MunichLMU$df_Output_Sex
#df_Sex_MunichLMU$Site <- "MunichLMU"

#df_Output_Sex_Matched_Main <-  rbind(df_Sex_Cologne, df_Sex_Frankfurt, df_Sex_Freiburg, 
#                             df_Sex_MunichLMU)
...
#df_Age_Cologne <- SiteOutputData_Matched$Cologne$df_Output_Age
#df_Age_Cologne$Site <- "Cologne"
#names(df_Age_Cologne)[2] <- "FirstRelevantAdmissionYear"

#df_Age_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_Age
#df_Age_Frankfurt$Site <- "Frankfurt"

#df_Age_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_Age
#df_Age_Freiburg$Site <- "Freiburg"

#df_Age_MunichLMU <- SiteOutputData_Matched$MunichLMU$df_Output_Age
#df_Age_MunichLMU$Site <- "MunichLMU"

#df_Output_Age_Matched_Main <- rbind(df_Age_Cologne, df_Age_Frankfurt, 
#                            df_Age_Freiburg, df_Age_MunichLMU)

# Age distribution summary statistics
#df_Age_Summary_Cologne <- SiteOutputData_Matched$Cologne$df_Output_Age_Summary
#df_Age_Summary_Cologne$Site <- "Cologne"

#df_Age_Summary_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_Age_Summary
#df_Age_Summary_Frankfurt$Site <- "Frankfurt"

#df_Age_Summary_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_Age_Summary
#df_Age_Summary_Freiburg$Site <- "Freiburg"

#df_Age_Summary_MunichLMU <- SiteOutputData_Matched$MunichLMU$df_Output_Age_Summary
#df_Age_Summary_MunichLMU$Site <- "MunichLMU"

#df_Output_Age_Summary_Matched_Main <-  rbind(df_Age_Summary_Cologne, df_Age_Summary_Frankfurt, 
 #                                    df_Age_Summary_Freiburg, df_Age_Summary_MunichLMU)
# Age distribution quantiles
#df_Age_Quantiles_Cologne <- SiteOutputData_Matched$Cologne$df_Output_Age_Quantiles
#df_Age_Quantiles_Cologne$Site <- "Cologne"

#df_Age_Quantiles_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_Age_Quantiles
#df_Age_Quantiles_Frankfurt$Site <- "Frankfurt"

#df_Age_Quantiles_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_Age_Quantiles
#df_Age_Quantiles_Freiburg$Site <- "Freiburg"

#df_Age_Quantiles_MunichLMU <- SiteOutputData_Matched$MunichLMU$df_Output_Age_Quantiles
#df_Age_Quantiles_MunichLMU$Site <- "MunichLMU"


#df_Output_Age_Quantiles_Matched_Main <-  rbind(df_Age_Quantiles_Cologne, 
...
#df_CaseCount_Cologne <- SiteOutputData_Matched$Cologne$df_Output_CaseCount
#df_CaseCount_Cologne$Site <- "Cologne"
#names(df_CaseCount_Cologne)[2] <- "FirstRelevantAdmissionYear"

#df_CaseCount_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_CaseCount
#df_CaseCount_Frankfurt$Site <- "Frankfurt"

#df_CaseCount_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_CaseCount
#df_CaseCount_Freiburg$Site <- "Freiburg"

#df_CaseCount_MunichLMU <- SiteOutputData_Matched$MunichLMU$df_Output_CaseCount
#df_CaseCount_MunichLMU$Site <- "MunichLMU"

#df_Output_CaseCount_Matched_Main  <- rbind(df_CaseCount_Cologne, df_CaseCount_Frankfurt, df_CaseCount_Freiburg, df_CaseCount_MunichLMU)


# Case count summary statistics
#df_CaseCount_Summary_Cologne <- SiteOutputData_Matched$Cologne$df_Output_CaseCount_Summary
#df_CaseCount_Summary_Cologne$Site <- "Cologne"

#df_CaseCount_Summary_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_CaseCount_Summary
#df_CaseCount_Summary_Frankfurt$Site <- "Frankfurt"

#df_CaseCount_Summary_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_CaseCount_Summary
#df_CaseCount_Summary_Freiburg$Site <- "Freiburg"

#df_CaseCount_Summary_MunichLMU <- SiteOutputData_Matched$MunichLMU$df_Output_CaseCount_Summary
#df_CaseCount_Summary_MunichLMU$Site <- "MunichLMU"

#df_Output_CaseCount_Summary_Matched_Main <- rbind(df_CaseCount_Summary_Cologne, 
...
#df_CaseCount_Quantiles_Cologne <- SiteOutputData_Matched$Cologne$df_Output_CaseCount_Quantiles
#df_CaseCount_Quantiles_Cologne$Site <- "Cologne"

#df_CaseCount_Quantiles_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_CaseCount_Quantiles
#df_CaseCount_Quantiles_Frankfurt$Site <- "Frankfurt"

#df_CaseCount_Quantiles_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_CaseCount_Quantiles
#df_CaseCount_Quantiles_Freiburg$Site <- "Freiburg"

#df_CaseCount_Quantiles_MunichLMU <- SiteOutputData_Matched$MunichLMU$df_Output_CaseCount_Quantiles
#df_CaseCount_Quantiles_MunichLMU$Site <- "MunichLMU"

#df_Output_CaseCount_Quantiles_Matched_Main <- rbind(df_CaseCount_Quantiles_Cologne, 
...
# Mean length of stay
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#df_LengOfStay_Cologne <- SiteOutputData_Matched$Cologne$df_Output_MeanLengthOfStay
#df_LengOfStay_Cologne$Site <- "Cologne"
#names(df_LengOfStay_Cologne)[2] <- "FirstRelevantAdmissionYear"

#df_LengOfStay_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_MeanLengthOfStay
#df_LengOfStay_Frankfurt$Site <- "Frankfurt"

#df_LengOfStay_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_MeanLengthOfStay
#df_LengOfStay_Freiburg$Site <- "Freiburg"

#df_LengOfStay_MunichLMU <- SiteOutputData_Matched$MunichLMU$df_Output_MeanLengthOfStay
#df_LengOfStay_MunichLMU$Site <- "MunichLMU"

#df_Output_MeanLengthOfStay_Matched_Main  <- rbind(df_LengOfStay_Cologne, 
...
#df_LengOfStay_Summary_Cologne <- SiteOutputData_Matched$Cologne$df_Output_MeanLengthOfStay_Summary
#df_LengOfStay_Summary_Cologne$Site <- "Cologne"

#df_LengOfStay_Summary_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_MeanLengthOfStay_Summary
#df_LengOfStay_Summary_Frankfurt$Site <- "Frankfurt"

#df_LengOfStay_Summary_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_MeanLengthOfStay_Summary
#df_LengOfStay_Summary_Freiburg$Site <- "Freiburg"

#df_LengOfStay_Summary_MunichLMU <- SiteOutputData_Matched$MunichLMU$df_Output_MeanLengthOfStay_Summary
#df_LengOfStay_Summary_MunichLMU$Site <- "MunichLMU"

#df_Output_MeanLengthOfStay_Summary_Matched_Main <- rbind(df_LengOfStay_Summary_Cologne, 
...
#df_LengOfStay_Quantiles_Cologne <- SiteOutputData_Matched$Cologne$df_Output_MeanLengthOfStay_Quantiles
#df_LengOfStay_Quantiles_Cologne$Site <- "Cologne"

#df_LengOfStay_Quantiles_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_MeanLengthOfStay_Quantiles
#df_LengOfStay_Quantiles_Frankfurt$Site <- "Frankfurt"

#df_LengOfStay_Quantiles_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_MeanLengthOfStay_Quantiles
#df_LengOfStay_Quantiles_Freiburg$Site <- "Freiburg"

#df_LengOfStay_Quantiles_MunichLMU <- SiteOutputData_Matched$MunichLMU$df_Output_MeanLengthOfStay_Quantiles
#df_LengOfStay_Quantiles_MunichLMU$Site <- "MunichLMU"

#df_Output_MeanLengthOfStay_Quantiles_Matched_Main <- rbind(df_LengOfStay_Quantiles_Cologne, 
...
#df_ICUTransfersRelative_Summary_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_ICUTransfersRelative_Summary
#df_ICUTransfersRelative_Summary_Frankfurt$Site <- "Frankfurt"

#df_ICUTransfersRelative_Summary_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_ICUTransfersRelative_Summary
#df_ICUTransfersRelative_Summary_Freiburg$Site <- "Freiburg"

#df_Output_ICUTransfersRelative_Summary_Matched_Main <- rbind(df_ICUTransfersRelative_Summary_Frankfurt, 
#                                                     df_ICUTransfersRelative_Summary_Freiburg) 

# ICU Transfer quantiles
#df_ICUTransfersRelative_Quantiles_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_ICUTransfersRelative_Quantiles
#df_ICUTransfersRelative_Quantiles_Frankfurt$Site <- "Frankfurt"

#df_ICUTransfersRelative_Quantiles_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_ICUTransfersRelative_Quantiles
#df_ICUTransfersRelative_Quantiles_Freiburg$Site <- "Freiburg"

#df_Output_ICUTransfersRelative_Quantiles_Matched_Main <- rbind(df_ICUTransfersRelative_Quantiles_Frankfurt, 
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# ICU Transfer summary statistic
#df_ICUTimeRelative_Summary_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_ICUTimeRelative_Summary
#df_ICUTimeRelative_Summary_Frankfurt$Site <- "Frankfurt"

#df_ICUTimeRelative_Summary_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_ICUTimeRelative_Summary
#df_ICUTimeRelative_Summary_Freiburg$Site <- "Freiburg"

#df_Output_ICUTimeRelative_Summary_Matched_Main <- rbind(df_ICUTimeRelative_Summary_Frankfurt, 
#                                                df_ICUTimeRelative_Summary_Freiburg) 

# ICU Transfer quantiles
#df_ICUTimeRelative_Quantiles_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_ICUTimeRelative_Quantiles
#df_ICUTimeRelative_Quantiles_Frankfurt$Site <- "Frankfurt"

#df_ICUTimeRelative_Quantiles_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_ICUTimeRelative_Quantiles
#df_ICUTimeRelative_Quantiles_Freiburg$Site <- "Freiburg"

#df_Output_ICUTimeRelative_Quantiles_Matched_Main <- rbind(df_ICUTimeRelative_Quantiles_Frankfurt, 
...
df_Output_AgeAtCancerDiagnosis_Matched_Main  <- rbind(df_AgeAtCancerDiagnosis_Cologne, 
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
df_Output_HIVCancerCategories_Cologne <- SiteOutputData_Matched$Cologne$df_Output_HIVCancerCategories
df_Output_HIVCancerCategories_Cologne$Site <- "Cologne"
names(df_Output_HIVCancerCategories_Cologne)[3] <- "MainCancerDiagnosisYear"

df_Output_HIVCancerCategories_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_HIVCancerCategories
df_Output_HIVCancerCategories_Frankfurt$Site <- "Frankfurt"

df_Output_HIVCancerCategories_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_HIVCancerCategories
df_Output_HIVCancerCategories_Freiburg$Site <- "Freiburg"

df_Output_HIVCancerCategories_MunichLMU <- SiteOutputData_Matched$MunichLMU$df_Output_HIVCancerCategories
df_Output_HIVCancerCategories_MunichLMU$Site <- "MunichLMU"

df_Output_HIVCancerCategories_Matched_Main <- rbind(df_Output_HIVCancerCategories_Cologne,
...
df_Output_CIS_Matched_Main <- rbind(df_Output_CIS_Cologne,
...
df_Output_MainCancerTopographyDetail_OverTime_Matched_Main <- rbind(df_Output_MainCancerTopographyDetail_OverTime_Cologne,
...
df_Output_MainCancerTopographyGroup_OverTime_Matched_Main <- rbind(df_Output_MainCancerTopographyGroup_OverTime_Cologne,
...
df_Output_CancerEntities_OverTime_Matched_Main <- rbind(df_Output_CancerEntities_OverTime_Cologne,
...
df_Output_MetastasisOccurrence_Matched_Main <- rbind(df_Output_MetastasisOccurrence_Cologne,
...
df_Output_TherapyModalities_Matched_Main <- rbind(df_Output_TherapyModalities_Cologne,
...
df_Output_TherapyComplications_Matched_Main <- rbind(df_Output_TherapyComplications_Cologne,
...
df_Output_LastRecordedDischargeCategory_Matched_Main <- rbind(df_Output_LastRecordedDischargeCategory_Cologne,
...
df_Output_HIVCancerDiagnosisOrder_Matched_Main <- rbind(df_Output_HIVCancerDiagnosisOrder_Cologne,
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
df_Output_HIVCancerAIDS_Cologne <- SiteOutputData_Matched$Cologne$df_Output_HIVCancerAIDS
df_Output_HIVCancerAIDS_Cologne$Site <- "Cologne"
names(df_Output_HIVCancerAIDS_Cologne)[2] <- "MainCancerDiagnosisYear"

df_Output_HIVCancerAIDS_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_HIVCancerAIDS
df_Output_HIVCancerAIDS_Frankfurt$Site <- "Frankfurt"

df_Output_HIVCancerAIDS_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_HIVCancerAIDS
df_Output_HIVCancerAIDS_Freiburg$Site <- "Freiburg"

df_Output_HIVCancerAIDS_MunichLMU <- SiteOutputData_Matched$MunichLMU$df_Output_HIVCancerAIDS
df_Output_HIVCancerAIDS_MunichLMU$Site <- "MunichLMU"

df_Output_HIVCancerAIDS_Matched_Main <- rbind(df_Output_HIVCancerAIDS_Cologne,
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
df_Output_AIDSOccurrence_Cologne <- SiteOutputData_Matched$Cologne$df_Output_AIDSOccurrence
df_Output_AIDSOccurrence_Cologne$Site <- "Cologne"
names(df_Output_AIDSOccurrence_Cologne)[2] <- "FirstRelevantAdmissionYear"

df_Output_AIDSOccurrence_Frankfurt <- SiteOutputData_Matched$Frankfurt$df_Output_AIDSOccurrence
df_Output_AIDSOccurrence_Frankfurt$Site <- "Frankfurt"

df_Output_AIDSOccurrence_Freiburg <- SiteOutputData_Matched$Freiburg$df_Output_AIDSOccurrence
df_Output_AIDSOccurrence_Freiburg$Site <- "Freiburg"

df_Output_AIDSOccurrence_MunichLMU <- SiteOutputData_Matched$MunichLMU$df_Output_AIDSOccurrence
df_Output_AIDSOccurrence_MunichLMU$Site <- "MunichLMU"

df_Output_AIDSOccurrence_Matched_Main <- rbind(df_Output_AIDSOccurrence_Cologne,
...
contain <- c("df_Output_PostalCodeCounts_Main" , "df_Output_SampleSize_Main", "df_Output_Sex_Main",
             ...
             "df_Output_PostalCodeCounts_Matched_Main" , "df_Output_SampleSize_Matched_Main", "df_Output_Sex_Matched_Main",
             "df_Output_Age_Matched_Main", "df_Output_Age_Summary_Matched_Main", "df_Output_Age_Quantiles_Matched_Main",
             "df_Output_CaseCount_Matched_Main", "df_Output_CaseCount_Summary_Matched_Main", "df_Output_CaseCount_Quantiles_Matched_Main",
             "df_Output_MeanLengthOfStay_Matched_Main", "df_Output_MeanLengthOfStay_Summary_Matched_Main", "df_Output_MeanLengthOfStay_Quantiles_Matched_Main",
             "df_Output_ICUTransfersRelative_Summary_Matched_Main", "df_Output_ICUTransfersRelative_Quantiles_Matched_Main",
             "df_Output_ICUTimeRelative_Summary_Matched_Main", "df_Output_ICUTimeRelative_Quantiles_Matched_Main",
             "df_Output_Matched_MainCancerDocumentedTimeSpan_Summary_Matched_Main", "df_Output_Matched_MainCancerDocumentedTimeSpan_Quantiles_Matched_Main",
             "df_Output_AgeAtCancerDiagnosis_Matched_Main", "df_Output_AgeAtCancerDiagnosis_Summary_Matched_Main", "df_Output_AgeAtCancerDiagnosis_Quantiles_Matched_Main",
             "df_Output_DistinctCodeCountCancer_Matched_Main", "df_Output_DistinctCodeCountCancer_Summary_Matched_Main",
             "df_Output_HIVCancerCategories_Matched_Main", "df_Output_CIS_Matched_Main", "df_Output_Matched_MainCancerTopographyDetail_Matched_Main",
             "df_Output_Matched_MainCancerTopographyDetail_OverTime_Matched_Main", "df_Output_Matched_MainCancerTopographyGroup_Matched_Main",
             "df_Output_Matched_MainCancerTopographyGroup_OverTime_Matched_Main", "df_Output_CancerEntities_Matched_Main",
             "df_Output_CancerEntities_OverTime_Matched_Main", "df_Output_MetastasisOccurrence_Matched_Main",
             "df_Output_TimeCancerToMetastasis_Summary_Matched_Main", "df_Output_TimeCancerToMetastasis_Quantiles_Matched_Main",  
             "df_Output_TherapyModalities_Matched_Main", "df_Output_CancerTherapySequence_Matched_Main", "df_Output_TherapyComplications_Matched_Main", 
             "df_Output_LastRecordedDischargeCategory_Matched_Main", "df_Output_HIVCancerDiagnosisOrder_Matched_Main",
             "df_Output_HIVCancerSequence_Matched_Main", "df_Output_HIVCancerAIDS_Matched_Main", "df_Output_AIDSOccurrence_Matched_Main",
