...
df_Output_PostalCodeCounts_Main <- rbind(df_Output_PostalCodeCounts_Frankfurt, 
...
df_Output_SampleSize_Main <- rbind(df_SampleSize_Frankfurt, 
...
df_Output_Sex_Main <-  rbind(df_Sex_Frankfurt, df_Sex_Freiburg, 
                             df_Sex_MunichLMU)
...
df_Output_Age_Main <- rbind(df_Age_Frankfurt, 
...
df_Output_CaseCount_Main  <- rbind(df_CaseCount_Frankfurt, df_CaseCount_Freiburg, df_CaseCount_MunichLMU)
...
df_Output_MeanLengthOfStay_Main  <- rbind(df_LengOfStay_Frankfurt, 
