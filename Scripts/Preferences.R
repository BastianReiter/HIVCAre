...
vc_MainSubgroups <- c("Cancer+/HIV-" = "Cancer+/HIV-",
                      "Cancer+/HIV+" = "Cancer+/HIV+",
                      "Cancer-/HIV+" = "Cancer-/HIV+")
...
vc_FillPalette_Subgroup <- c("Cancer+/HIV-" = color_CancerOnly,
                             "Cancer+/HIV+" = color_HIVCancer,
                             "Cancer-/HIV+" = color_HIVOnly)
...
vc_AlphaPalette_6 <- c(0.2, 0.35, 0.5, 0.6, 0.75, 0.9)
